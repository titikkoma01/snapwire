...
// FAVICON
	function childtheme_favicon() {
		...
		else { echo '<link rel="shortcut icon" href="'.OPTIONS_FRAMEWORK_DIRECTORY.'/images/favicon.ico" />'; }
	}
	...
	jQuery(document).ready(function() {
		...
		jQuery('#section-of_sr_footer1_text').hide();
		jQuery('#of_sr_footer1').click(function() { jQuery('#section-of_sr_footer1_text').fadeToggle(400); });
		if (jQuery('#of_sr_footer1:checked').val() !== undefined) { jQuery('#section-of_sr_footer1_text').show(); }
		jQuery('#section-of_sr_footer2_text').hide();
		jQuery('#of_sr_footer2').click(function() { jQuery('#section-of_sr_footer2_text').fadeToggle(400); });
		if (jQuery('#of_sr_footer2:checked').val() !== undefined) { jQuery('#section-of_sr_footer2_text').show(); }
	});
	</script>
